...
date: '2024-10-01'
summary: 'We are excited to share that powdr labs, originally an Ethereum Foundation project, is now an independent organization focused on the next generation of ZK tooling, security, and applied research.'
layout: PostBanner
